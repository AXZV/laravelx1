...
<script type="text/javascript" src="<?php echo e(URL::asset('js/konverter.js')); ?>"></script>
                ...
                <?php $no = 1 ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="javascript:;" data-toggle="modal" onclick="deleteData(<?php echo e($d->id); ?>)" data-target="#DeleteModal" class="btn btn-sm btn-danger"> Delete</a>
                            <a href="javascript:;" data-toggle="modal" onclick="editData( '<?php echo e($d->id); ?>', '<?php echo e($d->nama_siswa); ?>', '<?php echo e($d->alamat); ?>', '<?php echo e($d->nomor_telepon); ?>', '<?php echo $saldox ?>')" data-target="#modaledit" class="btn btn-sm btn-primary"> Edit</a>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel02\resources\views//crud/crud.blade.php ENDPATH**/ ?>